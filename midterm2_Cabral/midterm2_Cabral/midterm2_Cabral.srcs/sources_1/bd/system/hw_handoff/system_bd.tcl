...
proc create_root_design { parentCell } {
  ...
  set leds [ create_bd_cell -type ip -vlnv Diligent:user:user_led_ip:1.1 leds ]
  ...
  connect_bd_net -net user_led_ip_0_LED [get_bd_ports LED] [get_bd_pins leds/LED]
  ...
  create_bd_addr_seg -range 0x00010000 -offset 0x43C00000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs leds/S_AXI/S_AXI_reg] SEG_user_led_ip_0_S_AXI_reg

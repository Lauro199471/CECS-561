...
HD_PWD='c:/user_gpio_ip/ip_repo/edit_user_gpio_ip_v1_0.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log user_gpio_ip_v1_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source user_gpio_ip_v1_0.tcl

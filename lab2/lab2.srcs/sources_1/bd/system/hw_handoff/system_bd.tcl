...
proc create_root_design { parentCell } {
  ...
  connect_bd_intf_net -intf_net switchs_GPIO [get_bd_intf_ports sws_4bits] [get_bd_intf_pins switchs/GPIO]
  ...
  connect_bd_net -net rst_ps7_0_100M_peripheral_aresetn [get_bd_pins buttons/s_axi_aresetn] [get_bd_pins ps7_0_axi_periph/M00_ARESETN] [get_bd_pins ps7_0_axi_periph/M01_ARESETN] [get_bd_pins ps7_0_axi_periph/S00_ARESETN] [get_bd_pins rst_ps7_0_100M/peripheral_aresetn] [get_bd_pins switchs/s_axi_aresetn]

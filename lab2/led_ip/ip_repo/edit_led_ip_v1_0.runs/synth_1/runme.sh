...
HD_PWD='c:/led_ip/ip_repo/edit_led_ip_v1_0.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log led_ip_v1_0.vds -m64 -mode batch -messageDb vivado.pb -notrace -source led_ip_v1_0.tcl
